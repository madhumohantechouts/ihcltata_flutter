    ...
    return  Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          ...
          image: NetworkImage(responsibility.bannerList[index].image?.url ?? ""),
          fit: BoxFit.fill,
        ),
      ),
      child: Align(
          alignment: Alignment.center,
          child:Text(responsibility.bannerList[index].text ?? "",style: TextStyle(
      ...
      child: Observer(
        ...
        builder: (_) => CarouselSlider.builder(
          ...
          itemBuilder: (context, index, realIndex) {
            return responsibility.bannerList.isEmpty?Container():itemBuild(context, index);
          },
        ),
      ),
    );
